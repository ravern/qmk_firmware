...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | Alt  |      |      | Cmd  |Space |Lower |Raise |Space | Cmd  | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL, KC_LALT, _______, _______, KC_LGUI, KC_SPC,  LOWER,  RAISE,    KC_SPC,  KC_RGUI, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
   ...
   */
  [_LOWER] = LAYOUT( \
      _______, KC_F1,   KC_F2,    KC_F3,       KC_F4,     _______,                   KC_VOLU, KC_VOLD, _______, KC_MINS, KC_EQL,  _______, \
      _______, KC_F5,   KC_F6,    KC_F7,       KC_F8,     _______,                   _______, _______, _______, KC_LBRC, KC_RBRC, KC_BSLS, \
      _______, KC_F9,   KC_F10,   KC_F11,      KC_F12,    _______,                   _______, _______, _______, _______, _______, KC_QUOT, \
      KC_LSFT, _______, KC__MUTE, KC__VOLDOWN, KC__VOLUP, _______, _______, _______, _______, _______, _______, _______, _______, KC_RSFT, \
